                    ...
                    <tbody>
                        <tr>
                            <td class="table-active text-right align-middle" width="20%">
                                <div class="form-group mb-0{{ $errors->has('emp_name') ? ' has-error' : '' }} grp-emp_name">
                        ...
                        <tr>
                            <td class="table-active text-right align-middle" width="20%">
                                <div class="form-group mb-0{{ $errors->has('emp_address') ? ' has-error' : '' }} grp-emp_address">
                        ...
                        <tr>
                            <td class="table-active text-right align-middle" width="20%">
                                <div class="form-group mb-0{{ $errors->has('emp_auth_person') ? ' has-error' : '' }} grp-emp_auth_person">
                        ...
                        <tr>
                            <td class="table-active text-right align-middle" width="20%">
                                <div class="form-group mb-0{{ $errors->has('emp_contact') ? ' has-error' : '' }} grp-emp_contact">
