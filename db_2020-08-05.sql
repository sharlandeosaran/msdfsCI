...
CREATE TABLE IF NOT EXISTS `applicants` (
  ...
  CONSTRAINT `FK_applicants_persons` FOREIGN KEY (`person_id`) REFERENCES `persons` (`id`)
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci ROW_FORMAT=DYNAMIC;
...
-- Dumping structure for table msdfs_forms_db.persons
...
CREATE TABLE IF NOT EXISTS `persons` (
  ...
  `national_id_state_id` int(10) unsigned NOT NULL,
...
-- Dumping data for table msdfs_forms_db.persons: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `person_household` (
  ...
  CONSTRAINT `FK_person_household_persons` FOREIGN KEY (`person_id`) REFERENCES `persons` (`id`),
...
-- Dumping data for table msdfs_forms_db.status: ~4 rows (approximately)
