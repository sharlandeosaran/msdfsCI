...
INSERT INTO `applications` (`id`, `ip`, `form_id`, `status_id`, `created_at`, `updated_at`) VALUES
	(1, 'eyJpdiI6IllKTjBwTktTekt1UFZFYjRtQ1ZvOFE9PSIsInZhbHVlIjoiZHdXSXRuTzJVTmVnOXlCdDVXQUV6ZXFTS0IxUlpZdEt5NTIza2FLcGVKTT0iLCJtYWMiOiIyYjc0MjgwOWZiNDFmNTQxOTRhZjc3OTFlNmU1ODBlMDBiMDVkMjAyYjRkZWEwODAwMjViMGM1MzA1MTMyYTY0In0=', 3, 1, '2020-08-08 03:04:00', '2020-08-09 04:15:49'),
	(2, 'eyJpdiI6IkFYL2dyeXR3WlZxUUU1MFdHc2krWXc9PSIsInZhbHVlIjoidnBQckw4ZlRLQ2hsWFMxV2laRUQ2bERrL0x1YzJKR2ZYRDdiS01GWTc4ND0iLCJtYWMiOiI4M2U2ZTY0YjQ1YTMwMjQ3Yjk1YjEwMzhlNzZlYWFjZDc5ODYzZGJkYzEzMDZhYjhlZjUxYTRjMWJhM2RlZGY2In0=', 3, 1, '2020-08-08 16:26:32', '2020-08-09 03:43:27'),
	(3, 'eyJpdiI6IjZSUEVKUy9YOUIwbUxianVpL2VMQWc9PSIsInZhbHVlIjoiSEcwSGRCcGtVMjVic2VtUTdVZEVXK3VuOVBwVWx0Q252Tmh6NEdqbUNwYz0iLCJtYWMiOiJjN2IwZThhY2U0ZTgwMTBmMzAzM2JlNTQ2MmQzY2MyNWFiZmM4MWIyMTdkOWZkNjU5YjFjZWU3MWU2MTNiNDdhIn0=', 3, 1, '2020-08-08 18:15:31', '2020-08-09 04:07:00');
...
INSERT INTO `status` (`id`, `status`, `button`) VALUES
	(1, 'Active', 'activate'),
	(2, 'On Hold', 'on hold'),
	(3, 'Forwarded', 'forward'),
	(4, 'Logged', 'log'),
	...
	(8, 'Under Review', 'review'),
	(9, 'Approved', 'approve'),
	(10, 'Sent For Payment', 'payment'),
	(11, 'Rejected', 'reject');
...
INSERT INTO `users` (`id`, `first_name`, `surname`, `role_id`, `email`, `email_verified_at`, `active`, `password`, `remember_token`, `last_online`, `created_by`, `created_at`, `updated_at`) VALUES
	(1, 'Admin', NULL, 2, 'admin@email.com', NULL, 1, '$2y$10$aRBnMbZm1ld51AkoRYKd4uACqpoNXSaVYPjq74o94WAhb9fGDnaFm', NULL, '2020-08-08 14:53:52', NULL, '2020-05-02 04:29:15', '2020-08-08 14:53:52'),
