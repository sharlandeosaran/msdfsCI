...
-- Dumping data for table msdfs_forms_db.applications: ~2 rows (approximately)
...
-- Dumping data for table msdfs_forms_db.error_log: ~11 rows (approximately)
...
INSERT INTO `error_log` (`id`, `user`, `ip`, `action`, `exception`, `created_at`, `updated_at`) VALUES
	...
	(12, 'eyJpdiI6IjhMVmZmMnlNbjlkY2xZVUNwUWVwZXc9PSIsInZhbHVlIjoicno5SU5tZDJnTXR6TnJOcWMxV25ndz09IiwibWFjIjoiYzZkN2YyZWI0ZjkyZjdiOWZmZjc5YzBjZDA2YmZjOThmM2ZhNmI0Nzk1NWQyMmM1ZWVmZDc3ZGYxNDBjMzg1YiJ9', 'eyJpdiI6IjViQWx1ZXR3c04xVjU1Z1NoRGtlTVE9PSIsInZhbHVlIjoidU1HdElueXZIRFRLVFZGWEg2Vkhmc1ZLQzVJVEdPMVFDdHBPRm4ySmNoOD0iLCJtYWMiOiIyNTM3YThlMzQ0MTc2MGQwODNiODFkYjJhZDdjNDVjYjAwMmI2ZWI5ODU3NzQ0ZTA1ZmU2ZDY5NGQyOTE5Yjc2In0=', '', '', '2020-08-08 20:27:32', '2020-08-08 20:27:32');
...
CREATE TABLE IF NOT EXISTS `form_critical_incident` (
  ...
  `reference_number` varchar(50) NOT NULL DEFAULT '/2020',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Dumping data for table msdfs_forms_db.form_critical_incident: ~2 rows (approximately)
